...
\begin{table}[!t]
\caption{The 712 pre-flight checks by area. One check runs only where
\texttt{rclpy} is importable, so a machine with no ROS~2 reports 711.
The suite grew by 328 checks when the security posture of
