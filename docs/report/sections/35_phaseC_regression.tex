...
\begin{table}[!t]
\caption{The 750 pre-flight checks by area. One check runs only where
\texttt{rclpy} is importable, so a machine with no ROS~2 reports 749.
The suite grew by 366 checks when the security posture of
