...
\begin{table}[!t]
\caption{The 691 pre-flight checks by area. One check runs only where
\texttt{rclpy} is importable, so a machine with no ROS~2 reports 690.
The suite grew by 307 checks when the security posture of
