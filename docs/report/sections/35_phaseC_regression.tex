...
\begin{table}[!t]
\caption{The 732 pre-flight checks by area. One check runs only where
\texttt{rclpy} is importable, so a machine with no ROS~2 reports 731.
The suite grew by 348 checks when the security posture of
