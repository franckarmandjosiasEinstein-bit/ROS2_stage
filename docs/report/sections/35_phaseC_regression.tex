...
\begin{table}[!t]
\caption{The 654 pre-flight checks by area. One check runs only where
\texttt{rclpy} is importable, so a machine with no ROS~2 reports 653.
The suite grew by 270 checks when the security posture of
