...
\begin{table}[!t]
\caption{The 674 pre-flight checks by area. One check runs only where
\texttt{rclpy} is importable, so a machine with no ROS~2 reports 673.
The suite grew by 290 checks when the security posture of
