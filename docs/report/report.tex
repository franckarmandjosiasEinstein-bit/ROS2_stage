...
\input{sections/26_phaseC_overview}
\input{sections/27_phaseC_catalogue}
\input{sections/28_phaseC_navigation}
\input{sections/29_phaseC_alignment}
\input{sections/30_phaseC_measurement}
\input{sections/31_phaseC_security}
\input{sections/32_phaseC_protocol}
\input{sections/33_phaseC_cloud}
\input{sections/34_phaseC_route}
\input{sections/35_phaseC_regression}

% ---- Cross-cutting analysis ------------------------------------------
\input{sections/22_swot}
\input{sections/23_results}
\input{sections/36_extension}
