...
| `tests/check_cloud.py` | 476 pre-flight checks, none of which need a broker, ROS or a network |
...
prioritised over getting the 475 other checks to pass first.
...
— 475 on a machine with no ROS 2, where the numpy-against-rclpy clash is the
