...
| `tests/check_cloud.py` | 440 pre-flight checks, none of which need a broker, ROS or a network |
...
prioritised over getting the 439 other checks to pass first.
...
— 439 on a machine with no ROS 2, where the numpy-against-rclpy clash is the
